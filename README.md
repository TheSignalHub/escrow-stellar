...
- **Wallet Prep** — Review wallet destinations, buy source-wallet USDC through Privy, and convert supported Stellar assets through an AMM-style route before funding a deal. Friendbot remains testnet-only.
