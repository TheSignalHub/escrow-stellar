...
|---|---|---|---|
| 2026-07-26 00:36 BST | Admin mainnet inclusion fee | Added `ADMIN_RESOLUTION_INCLUSION_FEE_STROOPS` and defaulted mainnet server-side admin execution to `10000` stroops after low-fee admin submissions simulated successfully but timed out without landing. | `npm run build` passed in `indexer/`. |
